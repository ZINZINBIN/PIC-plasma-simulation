...
def parsing():
    ...
    parser.add_argument("--solver", type=str, default="SOR", choices=["SOR", "Gauss"])
...
if __name__ == "__main__":
    ...
    if args['use_animation']:
        generate_bump_on_tail_gif(snapshot, args['save_dir'], "{}_simulation_{}_{}.png".format(args['simcase'], args['interpol'], args['method']), 0, args['L'], -10.0, 10.0, args['plot_freq'], h_idx)
